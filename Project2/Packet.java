// This class defines the Pakcet strucure.
// This strucutre will also be used in future projects,
// so there are some addiotnal attributes included here,
// which will not be used in Project 2. These are marked below.
// When send ing a Packet, these attributes will just contain their
// default values specified in the constructor.
import java.util.*;
import java.io.*;
import java.io.*;
import java.net.*;
...
class Packet implements Serializable {
    ...
    //EVENT_TYPE CODES
    /*
        0-> Client sending initialization info to server
        1-> Client is requesting file form server (wants to know which peer has it)
        2-> Server is replying to client with peer id for file request
